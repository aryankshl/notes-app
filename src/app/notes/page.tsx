...
export default function NotesPage() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-start bg-[url('/bg-dark.png')] bg-cover bg-center min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-500 py-8 px-4">
      {/* Lamp strip */}
